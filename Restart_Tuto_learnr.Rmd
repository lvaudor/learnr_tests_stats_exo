...
-d’altérer l’apparence, de transformer en plante verte ou en limace (altération) 
- de se transformer soi-même, en loup-garou, troll ou beau gosse (transformation)
- de conjurer des esprits ou des morts-vivants (conjuration)
...
Quant aux modalités d’élaboration des potions, elles décrivent la nécessité d’une formule ou non, et si oui, en quelle langue (elfique ou latin). La préparation peut être effectuée par bouillon, macération ou distillation.
